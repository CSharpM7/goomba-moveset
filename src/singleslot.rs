...
fn csk_database(chara_hash: u64) {
    ...
    the_csk_collection_api::add_chara_db_entry_info(
        the_csk_collection_api::CharacterDatabaseEntry {
            ...
            skill_list_order: the_csk_collection_api::SignedByteType::Overwrite(skill_disp), 
            disp_order: the_csk_collection_api::SignedByteType::Optional(Some(disp)), 
            save_no: the_csk_collection_api::SignedByteType::Overwrite(save_no), 
            ...
            color_num: the_csk_collection_api::UnsignedByteType::Overwrite(colors), 

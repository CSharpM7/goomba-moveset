...
pub unsafe extern "C" fn attackhi4_exit(fighter: &mut L2CFighterCommon) -> L2CValue {
    AreaModule::enable_area(fighter.module_accessor, *FIGHTER_AREA_KIND_TREAD_PASSIVE, true, -1);
...
pub fn install(agent: &mut smashline::Agent) {
	...
	agent.status(Exit, *FIGHTER_STATUS_KIND_ATTACK_HI4, attackhi4_exit);
}
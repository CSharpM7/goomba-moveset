...
unsafe extern "C" fn game_fly(agent: &mut L2CAgentBase) {
    if macros::is_excute(agent) {
        ...
        println!("FF: {friendly_fire}");
        macros::ATTACK(agent, 0, 0, Hash40::new("top"), 5.0, 361, 70, 0, 50, 4.0, 0.0, 2.0, 0.0, None, None, None, 0.5, 1.3, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_SPEED, false, -2.5, 0.0, 60, true, false, false, false, false, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, friendly_fire, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_KAMEHIT, *ATTACK_REGION_OBJECT);
